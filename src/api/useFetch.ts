...
export const updateCurrentWorkout = (workoutData: IWorkoutModel) => {
  const updateWorkoutData = async (): Promise<void> => {
    await fetch(
      "http://127.0.0.1:8080/workouts/update-user-workout?id=" +
